                                ...
                                <section className='rounded-3xl bg-white/95 p-6 shadow-xl ring-1 ring-black/5 sm:p-10'>
                                        ...
                                        <div className='mt-6 flex justify-center'>
                                                <button
                                                        type='button'
                                                        onClick={() => navigate("/")}
                                                        className='inline-flex min-h-[3.25rem] min-w-[14rem] items-center justify-center gap-2 rounded-full bg-athath-charcoal px-8 text-base font-semibold text-white shadow-lg transition hover:bg-athath-charcoal/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-athath-charcoal/60'
                                                >
                                                                                                ...
                                                                                                storedItems.map((item) => {
                                                                                                        ...
                                                                                                        return (
                                                                                                                <tr
                                                                                                                        ...
                                                                                                                        className='border-b border-athath-charcoal/10 last:border-b-0'
                                                                                                                >
