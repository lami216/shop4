...
const ProductDetailPage = () => {
        ...
        if (!selectedProduct) {
                return (
                        <div className='relative min-h-screen text-athath-white'>
                                <div className='relative z-10 mx-auto max-w-4xl px-4 py-24 text-center'>
                                        <h1 className='text-3xl font-semibold text-athath-gold'>{t("products.detail.notFound.title")}</h1>
        ...
        return (
                <div className='relative min-h-screen overflow-hidden text-athath-white'>
                        <div className='relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8'>
                                <div className='grid gap-10 lg:grid-cols-2'>
                                        <div>
                                                <div className='relative flex h-96 items-center justify-center overflow-hidden rounded-2xl border border-athath-wood/40 bg-athath-charcoal/60'>
                                                        {isDiscounted && (
                                        ...
                                        <div className='flex flex-col gap-8 py-2 lg:pl-4'>
                                                <div className='space-y-6'>
                                                        {selectedProduct.category && (
                                                                <p className='text-sm font-medium uppercase tracking-wide text-athath-gold/80'>
                                                                        {selectedProduct.category}
                                                                </p>
                                                        )}
                                                        <div className='space-y-2'>
                                                                <p className='text-sm font-semibold text-white/70'>الإسم</p>
                                                                <h1 className='text-3xl font-bold text-athath-gold'>
                                                                        {selectedProduct.name}
                                                                </h1>
                                                        </div>
                                                        <div className='space-y-2'>
                                                                <p className='text-sm font-semibold text-white/70'>السعر</p>
                                                                <div className='flex flex-wrap items-center gap-4 text-3xl font-semibold text-athath-gold'>
                                                                        {isDiscounted ? (
                                                                                <>
                                                ...
                                                <div className='flex flex-wrap items-center gap-3 text-white/80'>
                                                        ...
                                                        <div className='flex items-center gap-3'>
                                                                <button
                                                                        ...
                                                                        className='inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition hover:border-athath-gold/80 hover:bg-athath-charcoal/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-athath-gold'
                                                ...
                                                <div className='space-y-3 text-white/80'>
                                                        <h2 className='text-lg font-semibold text-athath-gold'>
                                                ...
                                                <button
                                                        ...
                                                        className='inline-flex items-center justify-center rounded-full bg-athath-gold px-6 py-3 text-lg font-semibold text-athath-ink on-gold transition-colors duration-300 hover:bg-[#b8873d] focus:outline-none focus:ring-4 focus:ring-athath-gold/40'
                                                >
