...
const OrderSummary = () => {
        ...
        return (
                <motion.section
                        ...
                        dir='rtl'
                >
                        <h2 className='text-[clamp(1.4rem,3.2vw,1.7rem)] font-semibold text-athath-gold text-right'>
                                {t("cart.summary.title")}
                        </h2>

                        <div className='space-y-3 rounded-2xl border border-white/12 bg-athath-charcoal/70 p-5 text-[clamp(0.95rem,2.4vw,1rem)] text-white/80 shadow-inner'>
                                ...
                                <div className='flex items-center justify-between border-t border-white/12 pt-3 text-[clamp(1.1rem,2.8vw,1.3rem)] font-semibold'>
                                        <span className='text-athath-gold'>{t("cart.summary.grandTotal")}</span>
                        ...
                        <motion.button
                                type='button'
                                className='w-full rounded-full bg-athath-gold px-6 py-3 text-sm font-semibold text-athath-charcoal transition-colors duration-300 hover:bg-[#b8873d] focus:outline-none focus-visible:ring-2 focus-visible:ring-athath-gold focus-visible:ring-offset-2 focus-visible:ring-offset-athath-charcoal disabled:cursor-not-allowed disabled:opacity-60 md:w-1/2 md:self-end'
