      ...
      {items.map(({ key, label, href, className }) => {
        ...
        return (
          <a
            ...
            className={`inline-flex items-center gap-2 rounded-[18px] border border-white/10 bg-white/10 px-4 py-2 text-white transition duration-200 hover:bg-white/20 ${className}`}
            aria-label={label}
          >
